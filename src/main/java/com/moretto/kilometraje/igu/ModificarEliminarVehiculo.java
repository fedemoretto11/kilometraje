...
public class ModificarEliminarVehiculo extends javax.swing.JFrame {
    
    Controladora controladora = null;
    
    public ModificarEliminarVehiculo() {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            editarVehiculo.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            editarVehiculo.setTitle("Editar Vehiculo");
