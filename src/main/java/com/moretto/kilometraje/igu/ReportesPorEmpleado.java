...
public class ReportesPorEmpleado extends javax.swing.JFrame {
    
    Controladora controladora = null;

    
    public ReportesPorEmpleado() {
    ...
    private void initComponents() {
        ...
        inputEmpleado = new javax.swing.JComboBox<>();
        ...
        inputEmpleado.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(inputEmpleado, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(inputEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            String patente = extraerPatente((String) inputVehiculo.getSelectedItem());
            Integer dni = extraerDni((String) inputEmpleado.getSelectedItem());
            ...
            List<Registros> listaFiltrada = controladora.buscarListaRegistrosFiltrada(empleado, anio, mes);
...
//        cargarListadoVehiculos();
    ...
    private void cargarTabla(List<Registros> registros) {
        ...
        String titulos[] = {"Fecha","Vehiculo", "Kilometros"};
        tablaReporte.setColumnIdentifiers(titulos);
        if(registros != null) {
            for (Registros registro : registros) {
                Object[] objetosRegistro = {formatoFecha.format(registro.getFechaRegistro().getTime()),registro.getVehiculo().getPatente(), registro.getKmRecorridos()};
    ...
    private void cargarListadoPersonal(){
        inputEmpleado.addItem("");
        List<Empleado> listaEmpleados = controladora.buscarListaEmpleados();
        for (Empleado empleado : listaEmpleados) {
            inputEmpleado.addItem(empleado.getNombre() + " " + empleado.getApellido() + " (" + empleado.getDni() + ")");
        }  
    }
...
//    }  
    ...
    private javax.swing.JComboBox<String> inputEmpleado;
