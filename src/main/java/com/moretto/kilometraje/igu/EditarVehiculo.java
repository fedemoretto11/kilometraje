...
public class EditarVehiculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setText("Editar Vehiculo");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            if (confirmarEntrada("Desea guardar la edicion del vehiculo", "Confirmar") == 1) {
                if(controladora.buscarVehiculo(patente) != null) {
                    controladora.editarVehiculo(patente, marca, modelo, km);
                    mostrarMensaje("Vehiculo editar con exito", "Info", "Guardado exitoso");
                    limparCampos();
                } else {
                    mostrarMensaje("Error al completar la edicion", "Error", "Error al cargar");
                } 
            }
        } catch (Exception e) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        completarCampos(vehiculoEditar);
    ...
    private void completarCampos(Vehiculo vehiculo) {
        inputPatente.setText(vehiculo.getPatente());
        inputMarca.setText(vehiculo.getMarca());
        inputModelo.setText(vehiculo.getModelo());
        inputKm.setText(vehiculo.getKilometrosVehiculo().toString());
    }
