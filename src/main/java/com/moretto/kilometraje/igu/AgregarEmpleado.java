...
public class AgregarEmpleado extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            if (confirmarEntrada("Desea guardar el empleado", "Confirmar") == 1) {
                if(controladora.buscarEmpleado(dni) == null) {
                    controladora.guardarEmpleado(dni, nombre, apellido);
                    mostrarMensaje("Empleado guardado con exito", "Info", "Guardado exitoso");
                    limparCampos();
                } else {
                     mostrarMensaje("Ya existe un empleado con ese DNI cargado en sistema", "Error", "Error al cargar");
                }
